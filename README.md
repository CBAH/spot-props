...
phaseplots ensures slices meet the criteria for phase and snr, then plot all suitable data points in a 4-panel plot for each object which shows the amplitude, phase, spot temperature and spot size over time. 
